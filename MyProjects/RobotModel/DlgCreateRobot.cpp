// DlgCreateRobot.cpp : implementation file
//
...
CDlgCreateRobot::CDlgCreateRobot(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgCreateRobot::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgCreateRobot)
	m_armll = _T("");
	m_armlw = _T("");
	m_armrl = _T("");
	m_armrw = _T("");
...
void CDlgCreateRobot::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgCreateRobot)
...
BEGIN_MESSAGE_MAP(CDlgCreateRobot, CDialog)
	//{{AFX_MSG_MAP(CDlgCreateRobot)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgCreateRobot message handlers
